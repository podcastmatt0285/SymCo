    ...
    if is_bank_ipo:
        ...
        if not petrodollar_handled:
            ...
            try:
                ...
                # Track market sales tax paid for Tax Contributor task progress
                if _tax_deducted > 0 and sell_order.player_id > 0:
                    try:
                        from events import record_task_progress as _rtp
                        _rtp(sell_order.player_id, "market_sales_tax_usd", _tax_deducted)
                    except Exception:
                        pass
            except Exception as e:
