...
EXEC_ABILITIES = {
    ...
    "smart_contract_aud":  {"name": "Smart Contract Auditing", "desc": "Crypto/WSC yield +20%",                                "effect": "crypto",  "value": 0.20},
    ...
    "land_grant_prog":     {"name": "Land Grant Program",      "desc": "County taxes −20%",                                    "effect": "counties","value": 0.20},
    ...
    "regional_hub":        {"name": "Regional Hub",            "desc": "County business output +10%",                          "effect": "counties","value": 0.10},
    # ── P2P ───────────────────────────────────────────────────────────────────
    ...
    "deal_scout":          {"name": "Deal Scout",              "desc": "P2P listing/entry fees −15%",                          "effect": "p2p","value": 0.15},
    "rep_shield":          {"name": "Reputation Shield",       "desc": "P2P listing/entry fees −10%",                          "effect": "p2p","value": 0.10},
    "mediation_svc":       {"name": "Mediation Service",       "desc": "P2P listing/entry fees −20%",                          "effect": "p2p","value": 0.20},
