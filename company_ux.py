...
SITEMAP_ENTRIES = [
    ...
    ("/advisor",                     "Financial Advisor (Pro)","Private AI that knows the game, reads your books, and sizes up rivals — runs on your own free Gemini key"),
    ...
    ("/banks/indices",               "Market Indices",         "19 composite economic indices — WBC-50, sector indices, and custom baskets"),
    ...
    ("/p2p/dms/new",                 "New Direct Message",     "Start a new private conversation with another player"),
    ("/contacts",                    "Contacts",               "Full player directory — search by name, city, or company"),
    # ── Account & Estate ──────────────────────────────────────────────────────
    ("/notifications",               "Notifications",          "Your in-game notification inbox — market alerts, corporate events, and system messages"),
    ...
    ("/estate/deceased",             "Deceased Registry",      "Registry of all deceased players and their liquidated estates"),
    ...
    ("/wiki",                        "Wiki",                   "In-game encyclopedia — every item, business type, executive skill, and mechanic explained"),
    ("/stats/wiki",                  "Wiki Hub",               "Wiki landing page — videos, audio guides, and reference links for game mechanics"),
