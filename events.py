...
_DEFAULT_WEEKLY_TASKS = [
    ...
    },
    {
        ...
        "description":    (
            "Accumulate $15,000 in market sales taxes generated by your sell orders "
            "across the commodity and district markets. A 2.02% federal sales tax is "
            "levied on every trade and credited toward your total — plus any city sales "
            "tax if you operate in a city. No special setup needed: just keep selling."
        ),
        "duration_class": "weekly",
        "event_type":     "task",
