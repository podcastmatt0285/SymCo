...
class CityBank(Base):
    ...
    # Construction licenses (generated by City Post Office each tick)
    city_licenses = Column(Float, default=0.0)
...
def apply_to_city(player_id: int, city_id: int) -> Tuple[Optional[CityApplication], str]:
    ...
    try:
        ...
        # Check city isn't full (Municipal Center can expand capacity)
        ...
        try:
            ...
            effective_max = get_effective_max_members(city_id)
        except Exception:
            effective_max = MAX_CITY_MEMBERS
...
def get_city_stats(city_id: int) -> dict:
    ...
    try:
        ...
        try:
            from city_projects import get_effective_max_members
            effective_max_members = get_effective_max_members(city_id)
        except Exception:
            effective_max_members = MAX_CITY_MEMBERS
        ...
        return {
            ...
            "city_licenses": (getattr(bank, "city_licenses", 0.0) or 0.0) if bank else 0.0,
